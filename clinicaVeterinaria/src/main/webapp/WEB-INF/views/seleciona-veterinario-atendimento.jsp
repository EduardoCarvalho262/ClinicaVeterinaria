...
<head>
<meta charset="UTF-8">
<title>Seleciona  Veterinario</title>
<link href="/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
	
	
	<spring:url value="/atendimento/searchVet" var="search"></spring:url>
	<spring:url value="/atendimento/adicionaVeterinario" var="adiciona"></spring:url>
	...
	<div class="container">
		...
		<table class="table">
			...
			<c:forEach var="veterinario" items="${veterinarios}">
				<c:if test="${tipo == 'Emergencia'}">
					<c:if test="${veterinario.plantao == 'true'}">
						<tr>
							...
							<td><a href="${adiciona}/${veterinario.crmv}"
				...
				<c:if test="${tipo != 'Emergencia'}">
					<c:if test="${veterinario.plantao == 'false'}">
						<tr>
							<td>${veterinario.crmv}</td>
							<td>${veterinario.nome}</td>
							<td>${veterinario.endereco}</td>
		...
		<a href="/atendimento/showFormCadastro" class="btn btn-success">Voltar</a>
	</div>
